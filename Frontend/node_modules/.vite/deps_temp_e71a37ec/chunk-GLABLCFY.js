import {
  NoSsr_default,
  Popper_default
} from "./chunk-J5LVPRCW.js";
import {
  require_react_dom
} from "./chunk-PIBW2XQX.js";
import {
  Typography_default
} from "./chunk-L4KNKIBI.js";
import {
  CartesianProvider,
  ChartsText,
  DEFAULT_X_AXIS_KEY,
  ...
  useDrawingArea,
  useSeries
} from "./chunk-BMFY2PJZ.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-SRCT3FTM.js";
import {
  useThemeProps
} from "./chunk-D5M2NVOF.js";
import {
  useTheme
} from "./chunk-NFZFBJMA.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
function HighlightedProvider({
  ...
  const seriesById = React7.useMemo(() => {
  ...
  const providerValue = React7.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React14.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime4.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useChartGradient() {
  ...
  return React17.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React20.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React20.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React23.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime9.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime9.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime9.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime9.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime9.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime9.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime9.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime9.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime9.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime9.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const computeSize = React24.useCallback(() => {
...
var ResponsiveChartContainer = React25.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime10.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime10.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types9.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types9.default.shape({
    bottom: import_prop_types9.default.number.isRequired,
    height: import_prop_types9.default.number.isRequired,
    left: import_prop_types9.default.number.isRequired,
    right: import_prop_types9.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types9.default.arrayOf(import_prop_types9.default.shape({
    ...
    itemId: import_prop_types9.default.oneOfType([import_prop_types9.default.number, import_prop_types9.default.string]),
    label: import_prop_types9.default.string.isRequired,
    maxValue: import_prop_types9.default.oneOfType([import_prop_types9.default.instanceOf(Date), import_prop_types9.default.number]),
    minValue: import_prop_types9.default.oneOfType([import_prop_types9.default.instanceOf(Date), import_prop_types9.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime19.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(React39.Fragment, {
    ...
    }), (0, import_jsx_runtime20.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types11.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types11.default.oneOfType([import_prop_types11.default.number, import_prop_types11.default.string]),
  /**
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types11.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types11.default.number,
  /**
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types12.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types12.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React41.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime22.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime22.jsx)(ChartsAxisHighlightPath, {
...
//# sourceMappingURL=chunk-GLABLCFY.js.map
