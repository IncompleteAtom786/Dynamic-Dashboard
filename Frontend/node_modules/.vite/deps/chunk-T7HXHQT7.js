import {
  NoSsr_default,
  Popper_default
} from "./chunk-DNMVW5WW.js";
import {
  ZAxisContext,
  ZAxisContextProvider,
  getValueToPositionMapper,
  useChartId
} from "./chunk-MUO5KOVE.js";
import {
  ChartsSurface,
  InteractionContext,
  InteractionProvider,
...
} from "./chunk-TKEPQ7RR.js";
import {
  useSvgRef
} from "./chunk-ONHBTZ22.js";
import {
  require_react_dom
} from "./chunk-PIBW2XQX.js";
import {
  Typography_default
} from "./chunk-NXOZFBM7.js";
import {
  ChartsText,
  getStringSize,
  getWordsByLines
} from "./chunk-W75HDOPO.js";
import {
...
import {
  ...
  useDrawingArea,
  useSeries
} from "./chunk-REAX5ZJS.js";
import {
  useThemeProps
} from "./chunk-NSS67YN3.js";
import {
  useTheme
} from "./chunk-XXNETV7D.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
function useChartGradient() {
  ...
  return React9.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
  ...
  return (0, import_jsx_runtime4.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime4.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse,
          scale,
          colorScale,
          colorMap,
...
var AnimationContext = React10.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React11.useContext(AnimationContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React13.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React13.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React27.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
...
//# sourceMappingURL=chunk-T7HXHQT7.js.map
