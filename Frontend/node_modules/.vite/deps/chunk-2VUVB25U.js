...
function useChartGradient() {
  ...
  return React14.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React17.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
//# sourceMappingURL=chunk-2VUVB25U.js.map
