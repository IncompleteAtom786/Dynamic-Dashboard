...
import {
  NoSsr_default,
  Popper_default
} from "./chunk-T43RSFX5.js";
import {
  require_react_dom
} from "./chunk-PIBW2XQX.js";
import {
  Typography_default
} from "./chunk-QSIUORYT.js";
import {
...
var AnimationContext = React11.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React12.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React13.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
var ChartsSurface = React15.forwardRef(function ChartsSurface2(inProps, ref) {
      ...
      children: (0, import_jsx_runtime10.jsx)("tbody", {
        children: (0, import_jsx_runtime10.jsxs)(ChartsTooltipRow, {
          ...
          children: [(0, import_jsx_runtime10.jsx)(ChartsTooltipCell, {
            ...
            children: (0, import_jsx_runtime10.jsx)(ChartsTooltipMark, {
              color,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime12.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime12.jsx)("thead", {
        children: (0, import_jsx_runtime12.jsx)(ChartsTooltipRow, {
      ...
      }), (0, import_jsx_runtime12.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime12.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime12.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime12.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime12.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime12.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types6.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types6.default.shape({
    x: import_prop_types6.default.shape({
      index: import_prop_types6.default.number,
      value: import_prop_types6.default.oneOfType([import_prop_types6.default.instanceOf(Date), import_prop_types6.default.number, import_prop_types6.default.string]).isRequired
    }),
    y: import_prop_types6.default.shape({
      index: import_prop_types6.default.number,
      value: import_prop_types6.default.oneOfType([import_prop_types6.default.instanceOf(Date), import_prop_types6.default.number, import_prop_types6.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types6.default.oneOfType([import_prop_types6.default.instanceOf(Date), import_prop_types6.default.number, import_prop_types6.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime14.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime14.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime14.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime15.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime15.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime15.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React31.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React31.useMemo(() => {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React35.Fragment, {
    children: [(0, import_jsx_runtime19.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime19.jsx)("rect", _extends({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React37.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime21.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime21.jsx)(ChartsAxisHighlightPath, {
...
//# sourceMappingURL=chunk-57PBT4G4.js.map
